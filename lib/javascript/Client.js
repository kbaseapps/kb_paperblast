...
function kb_paperblast(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.paperblast_seq = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_paperblast.paperblast_seq",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_paperblast.status",
